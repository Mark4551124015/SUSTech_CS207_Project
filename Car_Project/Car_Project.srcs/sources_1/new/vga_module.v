...
module vga_module(
	...
	begin
		...
		if(hcount>=272&&vcount>=120&&hcount-272<=391&&vcount-120<=255)
		begin
			if(vcount-120<=63&&hcount-272<=335)
			begin
			...
			else if(vcount-120>63&&vcount-120<=127&&hcount-272<=335)
			begin
			...
			else if(vcount-120>127&&vcount-120<=191)
			begin
